...
import { faUtensils, faCalendar, faBurger, faPerson } from '@fortawesome/free-solid-svg-icons';
    ...
    return (
        <Flex direction='column' justify='space-between' align='start' py='30px' pr='10px' width='220px' height='100%' mr='40px'>
            <Flex direction='column' align='start' justify='start' gap='15px'>
                ...
                <SideButton to='members' icon={<FontAwesomeIcon icon={faPerson} />} text='Members' />
            </Flex>
        </Flex>
    )
}