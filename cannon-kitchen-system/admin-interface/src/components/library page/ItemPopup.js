                            ...
                            {fieldList.map((_,i)=>(
                                <Flex width = '100%' direction = 'column' gap = {2}>
                                    <Flex width = '100%'>
                                        ...
                                        <InputGroup flex = {1}>
                                            <Input value = {fieldList[i]?.field_name} onChange = {(e) => setFieldName(e.target.value, i)}/>
                                            <InputRightElement> 
                                        ...
                                        <Flex direction = 'column' gap = {1}>
                                            {fieldList[i]?.options?.map((_,j)=>(
                                                <Flex width = '100%'>
                                                    ...
                                                    <Input value = {fieldList[i]?.options[j]} onChange = {(e) => changeOptionName(e.target.value, i, j)} flex = {1} />
                                                </Flex>
                                            ))} 
                                        </Flex>
                                    </FormControl>
